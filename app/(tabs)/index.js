  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Animated.View style={[styles.rewardBox, styles.elevatedCard]}>
          ...
          >
            ...
            >
              <LinearGradient
                colors={
                  claimed ? ["#4CAF50", "#2E7D32"] : ["#FDCB6E", "#E17055"]
                }
        ...
        >
          {["Battle 1v1", "Casual", "Tournaments", "Fantasy", "Arcade"].map(
            (category) => (
              <TouchableOpacity
                key={category}
                style={[
            ...
            >
              ...
              <View style={styles.gameDetails}>
                ...
                <View style={styles.gameStats}>
                  ...
                  <Text style={styles.gamePlayers}>• 1.4K players</Text>
                </View>
              </View>
            </TouchableOpacity>
          ))}
